...
@section('title', 'Printora | ملابس تناسب كل يوم')
        ...
        <div class="row align-items-center py-lg-5">
            <div class="col-12">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a class="btn btn-brand px-4" href="{{ route('products.search') }}">تسوق الآن</a>
                    @auth
        ...
        <section class="pt-4 pb-5" id="products">
            <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-2 mb-4">
                <div>
                    ...
                    <p class="text-muted-custom mb-0">تصفّح أحدث القطع التي اخترناها لك في Printora.</p>
                </div>
